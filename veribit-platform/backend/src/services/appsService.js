...
module.exports = class AppsService {
  ...
  /**
   * Destroy all Appss with those ids.
   *
   * @param {*} ids
   */
  ...
  /**
   * Finds Appss based on the query.
   *
   * @param {*} args
   */
