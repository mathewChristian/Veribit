...
import exporterFields from 'modules/sign/list/signListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'SIGN_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await SignService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.sign.exporterFileName'),
