...
const actions = {
  ...
  doCreate: (values) => async (dispatch) => {
    try {
      ...
      Message.success(i18n('entities.apps.create.success'));
  ...
  doUpdate: (id, values) => async (
    ...
    try {
      ...
      await AppsService.update(id, values);

      dispatch({
        type: actions.UPDATE_SUCCESS,
      });

      Message.success(i18n('entities.apps.update.success'));
