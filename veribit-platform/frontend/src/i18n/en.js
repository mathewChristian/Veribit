const en = {
  ...
  entities: {
    ...
    partner: {
      ...
      destroyAll: {
        success: 'Partner(s) deleted successfully',
      },
      edit: {
        title: 'Edit Partner',
      },
  ...
  roles: {
    ...
    mediaEditor: {
      label: 'Media Editor',
      description: 'Edit access to Media',
    },
    mediaViewer: {
      label: 'Media Viewer',
      description: 'View access to Media',
    },
    signEditor: {
      label: 'Sign Editor',
      description: 'Edit access to Signs',
    },
    signViewer: {
      label: 'Sign Viewer',
      description: 'View access to Signs',
    },
    shareEditor: {
      label: 'Share Editor',
      description: 'Edit access to Share',
    },
    shareViewer: {
      label: 'Share Viewer',
