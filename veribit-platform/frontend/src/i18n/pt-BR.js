const ptBR = {
  ...
  roles: {
    ...
    mediaEditor: {
      ...
      description: 'Acesso de edição aos Media',
    },
    mediaViewer: {
      label: 'Visualizador de Media',
      description: 'Acesso de visualização aos Media',
    },
    signEditor: {
      label: 'Editor de Signs',
      description: 'Acesso de edição aos Signs',
    },
    signViewer: {
      label: 'Visualizador de Signs',
      description: 'Acesso de visualização aos Signs',
    },
    shareEditor: {
      label: 'Editor de Share',
      description: 'Acesso de edição aos Share',
    },
    shareViewer: {
