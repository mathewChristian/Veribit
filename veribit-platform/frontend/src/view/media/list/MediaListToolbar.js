...
function select(state) {
  return {
    ...
    hasPermissionToEdit: mediaSelectors.selectPermissionToEdit(
      state,
    ),
    hasPermissionToDestroy: mediaSelectors.selectPermissionToDestroy(
      state,
    ),
    hasPermissionToCreate: mediaSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: mediaSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(MediaToolbar);
