...
import AppsFormModal from 'view/apps/form/AppsFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/apps/appsSelectors';

class AppsAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return AppsService.listAutocomplete(value, limit);
  };
...
export default connect(select)(AppsAutocompleteFormItem);
