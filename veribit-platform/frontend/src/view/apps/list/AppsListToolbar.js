...
class AppsToolbar extends Component {
  doExport = () => {
    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=apps">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: appsSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: appsSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(AppsToolbar);
