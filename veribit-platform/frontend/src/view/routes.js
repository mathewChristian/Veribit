...
const privateRoutes = [
  ...
  {
    path: '/apps',
    loader: () => import('view/apps/list/AppsListPage'),
    permissionRequired: permissions.appsRead,
    exact: true,
    icon: 'right',
    label: i18n('entities.apps.menu'),
    menu: true,
  },
  {
    path: '/apps/new',
    loader: () => import('view/apps/form/AppsFormPage'),
    menu: false,
    permissionRequired: permissions.appsCreate,
    exact: true,
  },
  {
    path: '/apps/importer',
    loader: () =>
      import('view/apps/importer/AppsImporterPage'),
    menu: false,
    permissionRequired: permissions.appsImport,
    exact: true,
  },
  {
    path: '/apps/:id/edit',
    loader: () => import('view/apps/form/AppsFormPage'),
    menu: false,
    permissionRequired: permissions.appsEdit,
    exact: true,
  },
  {
    path: '/apps/:id',
    loader: () => import('view/apps/view/AppsViewPage'),
    menu: false,
    permissionRequired: permissions.appsRead,
    exact: true,
  },
