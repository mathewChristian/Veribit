...
import ShareFormModal from 'view/share/form/ShareFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/share/shareSelectors';

class ShareAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return ShareService.listAutocomplete(value, limit);
  };
...
export default connect(select)(ShareAutocompleteFormItem);
