...
import PartnerFormModal from 'view/partner/form/PartnerFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/partner/partnerSelectors';

class PartnerAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
...
export default connect(select)(PartnerAutocompleteFormItem);
