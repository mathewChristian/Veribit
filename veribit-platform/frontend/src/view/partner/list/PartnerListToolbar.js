...
class PartnerToolbar extends Component {
  doExport = () => {
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: partnerSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: partnerSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(PartnerToolbar);
